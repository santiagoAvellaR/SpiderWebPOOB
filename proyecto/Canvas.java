...
public class Canvas{
    ...
    public static Canvas getCanvas(){
        if(canvasSingleton == null) {
            canvasSingleton = new Canvas("BlueJ Shapes Demo", 3750, 800, 
                                         Color.white);
        }
    ...
    private Color brownColor = new Color(139, 69, 19);
    private Color vibrantOrange = new Color(255, 128, 0);
    ...
    public void setForegroundColor(String colorString){
        if (colorString.equals("red"))
            ...
            graphic.setColor(vibrantOrange);
        else if(colorString.equals("pink"))
            graphic.setColor(Color.pink);
        else if(colorString.equals("darkGreen"))
            graphic.setColor(Color.green.darker().darker());
        else if(colorString.equals("brown"))
            graphic.setColor(brownColor);
            else if(colorString.equals("darkBrown"))
            graphic.setColor(brownColor.darker());
